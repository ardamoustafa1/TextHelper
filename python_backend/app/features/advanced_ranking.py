...
class AdvancedRanking:
    ...
    def __init__(self):
        ...
        self.weights = {
            'frequency': 0.15,        # Kelime frekansı
            'user_preference': 0.30,  # Kullanıcı tercihi (agresif)
            'context_relevance': 0.25,# Bağlam uyumu
            'typo_distance': 0.10,    # Yazım hatası mesafesi
            'time_decay': 0.10,       # Zaman bazlı azalma
            'source_quality': 0.10    # Kaynak kalitesi
        }
